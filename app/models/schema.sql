...
COPY user_details from '/app/models/dummyData/dummyUserDetails.csv' DELIMITER ',' CSV HEADER;

COPY user_school_details from './app/models/dummyData/dummySchoolDetails.csv' DELIMITER ',' CSV HEADER;
